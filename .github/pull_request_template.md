...
<!-- Briefly describe the main changes included in this PR -->

---

## 🎯 Type of change

<!-- Mark with [x] the type of change that applies -->
...
<!-- Mark with [x] the areas of the library that were modified -->
...
<!-- Highlight specific aspects that need special attention -->

### Changes requiring special attention

<!-- Mention any complex or critical changes -->

### Additional setup required

<!-- If the PR requires additional setup in development/production -->
