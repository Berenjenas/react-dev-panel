...
export interface DevPanelProps {
	 ...
	 * ```
	 */
	hotKeyConfig?: Pick<HotkeyConfig, "key" | "shiftKey" | "altKey" | "ctrlKey" | "metaKey">;
}
...
export type AvailableControls = keyof typeof controls;

export type Control = NumberControl | BooleanControl | SelectControl | ColorControl | TextControl | ButtonControl;

export type ControlGroup = Record<string, Control>;

export interface ControlRendererProps {
	name: string;
	control: ControlGroup[keyof ControlGroup];
}
